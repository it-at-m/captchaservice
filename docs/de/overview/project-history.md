...
2. **Kommerzielle, proprietäre CAPTCHA-Dienste** — funktionierten im Produktivbetrieb gut, waren als Closed-Source-Angebote mit externem Hosting für eine öffentliche Verwaltung aber letztlich nicht die passendste Lösung.
...
- Es verlassen keine personenbezogenen Daten die Münchner Infrastruktur.
...
- **Wiederverwendbar**: jedes Spring-Boot- oder anderssprachige Frontend kann den Dienst über HTTP aufrufen, eine eigene Site mit Schlüssel/Geheimnis konfigurieren und eine eigene Schwierigkeits-Map nutzen.
