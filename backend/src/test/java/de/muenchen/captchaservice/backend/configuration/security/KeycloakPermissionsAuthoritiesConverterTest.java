package de.muenchen.captchaservice.backend.configuration.security;

import static de.muenchen.captchaservice.backend.TestConstants.SPRING_TEST_PROFILE;
import static de.muenchen.captchaservice.backend.configuration.security.KeycloakPermissionsAuthoritiesConverter.PERMISSION_LIST;
